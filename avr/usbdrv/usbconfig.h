 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xeb, 0x03 /* VOTI's lab use PID */
 ...
 */
#define USB_CFG_VENDOR_NAME     'M','e','t','a','M','e','u','t','e'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'L','i','c','h','t','s','e','n','s','o','r'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    14
